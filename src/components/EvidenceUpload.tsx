...
export const EvidenceUpload: React.FC<Props> = ({ evidencias, onChange }) => {
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
        ...
        <button
          ...
          className="aspect-square rounded-2xl border-2 border-dashed border-slate-300 bg-slate-100/40 flex flex-col items-center justify-center gap-1 text-slate-400 hover:border-indigo-400 hover:text-indigo-400 hover:bg-white/60 transition-all cursor-pointer"
        >
          <Camera size={24} strokeWidth={1.5} />
          <span className="text-[9px] font-black uppercase tracking-tighter">Click / Foto</span>
        </button>
      </div>
